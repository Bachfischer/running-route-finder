...
3. Project the start onto the nearest accessible path segment within 300 m, splitting that segment while preserving pedestrian one-way restrictions. Separately mapped sidewalks do not authorize routing on a secondary road’s centerline. Report the offset; never invent a straight connector across a building or river.
